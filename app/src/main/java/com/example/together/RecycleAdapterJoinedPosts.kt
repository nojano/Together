...
class RecycleAdapterJoinedPosts : RecyclerView.Adapter<RecycleAdapterJoinedPosts.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecycleAdapterJoinedPosts.ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.actvity_joined_groups_card, parent, false)
        return ViewHolder(v)
    }

    override fun onBindViewHolder(holder: RecycleAdapterJoinedPosts.ViewHolder, position: Int) {
